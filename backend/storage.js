...
export class DatabaseStorage {
    ...
    updateSystemTab(id, tab) {
        return __awaiter(this, void 0, void 0, function* () {
            const [updated] = yield db.update(systemTabs)
                .set(tab)
    ...
    toggleSystemTab(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const [tab] = yield db.select().from(systemTabs).where(eq(systemTabs.id, id));
            if (!tab) {
                return false;
            }
            const [updated] = yield db.update(systemTabs)
    ...
    createSystemUpdate(update) {
        return __awaiter(this, void 0, void 0, function* () {
            const [newUpdate] = yield db.insert(systemUpdates).values(update).returning();
            return newUpdate;
        });
    }
    /**
    ...
    deploySystemUpdate(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const [updated] = yield db.update(systemUpdates)
    ...
    getSystemSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield db.select().from(systemSettings);
        });
    }
    /**
    ...
    updateSystemSetting(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            const [updated] = yield db.update(systemSettings)
                .set({ value })

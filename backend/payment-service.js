...
class PaymentServiceFactory {
    static orangeMoney = new OrangeMoneyService({
    ...
    static mtnMomo = new MTNMomoService({
    ...
    static moovMoney = new MoovMoneyService({
...
export class PaymentService {
    static async initiatePayment(paymentConfig) {
    ...
    static async checkPaymentStatus(method, transactionId) {
        if (method === "cash") {
            return {
                transactionId,
                status: "success",
    ...
    static async processWebhook(method, data) {
        const service = PaymentServiceFactory.getService(method);
        if (!service) {

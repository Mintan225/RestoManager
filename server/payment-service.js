...
class OrangeMoneyService extends BasePaymentService {
    ...
    processWebhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof data === 'object' && data !== null && 'pay_token' in data && typeof data.pay_token === 'string') {
...
class MTNMomoService extends BasePaymentService {
    ...
    processWebhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof data === 'object' && data !== null && 'referenceId' in data && typeof data.referenceId === 'string') {
...
class MoovMoneyService extends BasePaymentService {
    ...
    processWebhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof data === 'object' && data !== null && 'transactionId' in data && typeof data.transactionId === 'string') {

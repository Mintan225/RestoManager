...
export default function SuperAdminLayout({ children, title, showBackButton = false }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              {showBackButton && (<Button variant="ghost" size="sm" onClick={() => setLocation("/super-admin/dashboard")} className="ml-4 text-red-600 hover:bg-red-50">
          ...
          <div className="border-t border-red-100 pt-2 pb-2">
            ...
            return (<Button key={item.path} variant="ghost" size="sm" onClick={() => setLocation(item.path)} className={`flex items-center space-x-2 px-3 py-2 rounded-md text-sm ${isActive

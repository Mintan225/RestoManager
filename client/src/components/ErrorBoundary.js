...
class ErrorBoundary extends Component {
    ...
    render() {
        ...
        if (this.state.hasError) {
            ...
            return (<div style={{ padding: '20px', textAlign: 'center', border: '1px solid #e0e0e0', borderRadius: '8px', margin: '20px auto', maxWidth: '600px', backgroundColor: '#f8f8f8' }}>
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (<details style={{ marginTop: '20px', textAlign: 'left', backgroundColor: '#eee', padding: '10px', borderRadius: '4px' }}>
